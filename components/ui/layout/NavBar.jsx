...
export default function NavBar() {
  ...
  const showWalletDetails = pathname !== '/marketplace'
        ...
        <div className='flex justify-between items-center px-4 py-6 sm:px-6 md:justify-start md:space-x-10'>
          ...
          <div className='hidden md:flex-1 md:flex md:items-center md:justify-between'>
            <Popover.Group as='nav' className='flex space-x-10'>
                                  ...
                                  products?.map(item => (
                                      <Link
                                        ...
                                        <div
                                          ...
                                          <div
                                              className='relative flex-shrink-0 flex items-center justify-center h-10 w-10 rounded-md bg-indigo-500 text-white sm:h-12 sm:w-12'>
                                            <Image
                                                src={item.coverImage}
                                                layout='fill'
                                                objectFit='cover'
              ...
              <Link href={"/marketplace"} className="text-gray-700 hover:text-gray-700">
            ...
            <div className="flex justify-between">
              {showWalletDetails && account.data && (
                  <div
                      className="flex items-center md:-mr-14 bg-yellow-200 px-7 py-3 rounded-md shadow-md text-sm font-semibold">
                        ...
                        products?.map((item, itemIndex) => (
                            <Link
                              ...
                              <motion.div
                                ...
                                <div
                                    className='relative flex-shrink-0 flex items-center justify-center h-10 w-10 rounded-md bg-indigo-500 text-white'>
                                  <Image
                                      src={item.coverImage}
                                      layout='fill'
                                      objectFit='cover'
